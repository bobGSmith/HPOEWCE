...
#' is 14. In otherwords there are 14 generations of "is-a" relationships below
...
#'
#' @param hpo The Human phenotype ontology data object, available in ontologyIndex package <list>
#' @param term_ids A HPO Id (e.g. "HP:0000001") or a vector of multiple Ids <string> or <vector<string>>
#' @examples \dontrun{
#' term_ids <- "HP:0000001"
